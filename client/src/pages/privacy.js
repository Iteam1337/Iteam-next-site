...
import { Box, List, Section, Typography } from '../components/Core'
            ...
            <div>
              ...
              <Box mt={['40px', null, '50px']}>
                ...
                <Typography.ParagraphSmall>
                  ...
                  livet. Nedan riktlinjer följer de skyldigheter och rättigheter
                  som gäller enligt dataskyddsförordningen eller annan rättsligt
              ...
              <Box mt={['40px', null, '50px']}>
                ...
                <List>
                  <StyledLi>
                    Du själv lämnar dessa till oss, exempelvis i samband med att
                  ...
                  <StyledLi>
                    Du själv lämnar dessa till oss, exempelvis i samband med att
                    registrerar dig till våra event, i kontakt försäljning, i
                    kontakt via e-post, brev eller via kontaktformulär.
                  </StyledLi>
                  <StyledLi>
                    Du själv lämnar dina uppgifter till en leverantör och
                    samarbetspartners som i sin tur har ditt medgivande att dela
                    dina personuppgifter med oss.
                  </StyledLi>
                  <StyledLi>
                    Vi förbehåller oss också rätten att inhämta uppgifter från
                    tredje part (ex Creditsafe, SPAR, UC m.fl.) Dessa uppgifter
                    är exempelvis namn, kontaktuppgifter, bolagsengagemang och
                    demografisk data, kreditvärdighet.
                  </StyledLi>
                </List>
              </Box>
              <Box mt={['40px', null, '50px']}>
                ...
                <Typography.ParagraphSmall>
                  De kategorier av personuppgifter som vi samlar, eller har rätt
                  att samla in, är:
                </Typography.ParagraphSmall>
                <List>
                  <StyledLi>
                  ...
                  <StyledLi>
                    Besöksinformation på icke-inloggade och inloggade tjänster,
                    det vill säga din användargenererade data, data rörande
                    vilken enhet som används och viss interaktionsdata
                  </StyledLi>
                </List>
              </Box>
              <Box mt={['40px', null, '50px']}>
                ...
                <Typography.ParagraphSmall>
                  ...
                  uppgifterna samlas in för behandling med stöd av den rättsliga
                  grunden <b>fullgörande av avtal.</b> Ändamålen är till
                  exempel:
                </Typography.ParagraphSmall>
                ...
                <Typography.ParagraphSmall>
                  ...
                  fall då inget av ovanstående gäller. Ett lämnat samtycke är en
                  aktiv handling från dig och den kan återkallas vilket leder
                  till att vi inte längre behandlar dina personuppgifter
              ...
              <Box mt={['40px', null, '50px']}>
                ...
                <Typography.ParagraphSmall>
                  För marknadsföring och försäljning inhämtar vi personuppgifter
                  från bl.a . Creditsafe, Bisnode och andra offentliga källor i
                  syfte att hitta mottagare för våra erbjudanden.
                </Typography.ParagraphSmall>
              </Box>
              <Box mt={['40px', null, '50px']}>
                <Typography.H2>
                ...
                <Typography.ParagraphSmall>
                  ...
                  inte är kund hos oss så behåller vi dina uppgifter i upp till
                  48 månader. Vissa uppgifter kan dock behöva sparas för längre
                  tid för att uppfylla andra legala krav, till exempel rörande
                  bokföring där vi behöver spara uppgifter i enlighet med
                  bokföringslagen. Det finns också skäl att spara uppgifterna
                  för längre tid om det pågår en utredning eller en tvist, även
                  om kundförhållandet sedan tidigare har upphört, eller i fall
                  då du köpt en produkt av oss där vi behöver spara uppgifterna
                  för att på annat sätt kunna fullgöra vårt åtagande.
                </Typography.ParagraphSmall>
              </Box>
              ...
              <Box mt={['40px', null, '50px']}>
                ...
                <Typography.ParagraphSmall>
                  ...
                  att skydda de personuppgifter som behandlas så att uppgifterna
                  inte förloras, förstörs, manipuleras eller blir tillgängliga
                  för obehöriga.
                </Typography.ParagraphSmall>
              </Box>
              ...
              <Box mt={['40px', null, '50px']}>
                ...
                <Typography.ParagraphSmall>
                  Du har rätt till tillgång, rättelse och radering av uppgifter
                  enligt följande:
                </Typography.ParagraphSmall>
                <List>
                  <StyledLi>
                    {' '}
                    Du har rätt att få information om i vilka personuppgifter vi
                    innehar om dig.
                  </StyledLi>
                  <StyledLi>
                    {' '}
                  ...
                  <StyledLi>
                    ...
                    återkallar samtycket, om uppgifterna inte längre behövs för
                    de ändamål som de behandlats för eller om radering krävs för
