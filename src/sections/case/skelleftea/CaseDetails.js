        ...
        <Row>
          <Col lg="12" xl="10" className="offset-xl-1">
            <Box pb={["40px", null, "65px"]}>
              ...
              <Text variant="small" mb="18px">
              Parallellt med den juridiska processen kontaktade Skellefteå kommun Iteam för hjälp med att se om en annan teknisk lösning skulle kunna lösa utmaningen att använda ansiktsigenkänning i skolmiljö utan att bryta mot Datainspektionens hårda GDPR-tolkning. 
              Lösningen blev en helt ny hantering av känsliga personuppgifter som inte bygger på medgivande till att kommunen lagrar personuppgifter - den bygger istället på att kommunen inte alls lagrar några personuppgifter. 
              Konceptet heter Egendata och bygger på att varje elev lagrar personuppgifterna på en plats som de själva kontrollerar. 
              Elevens ansiktsmodell lagras med en stark kryptering och eleven kan därefter dela ut en nyckel till kommunen som då kan läsa in modellen när den behövs för närvarokontrollen. Informationen finns bara i minnet på systemet som genomför ansiktsigenkänningen, och eleven kan via en mobilapp när som helst återkalla nyckeln man delat till kommunen och därmed stoppa tillgången till personuppgifterna. Hela projektet har präglats av sin explorativa natur och har inneburit ett mycket nära samarbete mellan Iteam och kunden, med en spännande mix av teknisk, juridisk och verksamhetsnära kompetens.
              </Text>
              ...
              <Text variant="small">
              Den nya arkitekturen för lagring av personuppgifter hos personuppgiftslämnaren själv möjliggör att användningen av personuppgifterna ses som ett avtal istället för ett medgivande. 
              Det stora fokuset på kryptering, transparens och direktkontroll hos användaren som är kännetecknande för Egendata talar för ett nytt och positivt besked från Datainspektionen. En ansökan om förhandssamråd kring den nya lösningen är nu inskickad och väntar på svar från myndigheten.
              </Text>   
            </Box>
          </Col>
        </Row>
