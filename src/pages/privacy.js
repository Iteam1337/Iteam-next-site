            ...
            <Row className="justify-content-center">
              <Col lg="9" xl="8">
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <List>
                    <StyledLi>Du själv lämnar dessa till oss, exempelvis i samband med att du blir kund hos oss.</StyledLi>
                    <StyledLi>Du själv lämnar dessa till oss i samband med frivilliga användartester, workshops eller liknande tillställningar.</StyledLi>
                    <StyledLi>Du själv lämnar dessa till oss, exempelvis i samband med att registrerar dig till våra event, i kontakt försäljning, i kontakt via e-post, brev eller via kontaktformulär.</StyledLi>
                    <StyledLi>Du själv lämnar dina uppgifter till en leverantör och samarbetspartners som i sin tur har ditt medgivande att dela dina personuppgifter med oss.</StyledLi>
                    <StyledLi>Vi förbehåller oss också rätten att inhämta uppgifter från tredje part (ex Creditsafe, SPAR, UC m.fl.) Dessa uppgifter är exempelvis namn, kontaktuppgifter, bolagsengagemang och demografisk data, kreditvärdighet.</StyledLi>
                  </List>
                </Box>
                <Box mt={["40px", null, "50px"]}>
                  <Title variant="card" fontSize="2rem" mb="30px">
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <List>
                    <StyledLi>   för marknadsföring och profilering, det vill säga för att kommunicera relevanta erbjudanden till dig </StyledLi>
                    <StyledLi>   för försäljning av våra erbjudanden</StyledLi>
                    <StyledLi>    för att skicka nyhetsbrev</StyledLi>
                    <StyledLi>   för att utveckla och förbättra våra produkter och tjänster </StyledLi>
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <List>
                    <StyledLi>  Du har rätt att få information om i vilka personuppgifter vi innehar om dig.</StyledLi>
                    <StyledLi>  Du har rätt att begära rättelse av dina personuppgifter om information om dom är felaktiga.</StyledLi>
                    <StyledLi>  Du har rätt att få dina personuppgifter raderade om behandlingen grundar sig enbart på ditt samtycke och du återkallar samtycket, om uppgifterna inte längre behövs för de ändamål som de behandlats för eller om radering krävs för att uppfylla en rättslig skyldighet</StyledLi>
                  </List>
                </Box>
