            ...
            <Row className="justify-content-center">
              <Col lg="9" xl="8">
                ...
                <Box mt={["40px", null, "50px"]}>
                  ...
                  <Text variant="small">
                    Med personuppgifter avses all slags information som direkt eller indirekt kan hänföras till en fysisk person som är i livet. Iteam Solutions AB är personuppgiftsansvarig för de uppgifter som du tillhandahåller oss eller som inhämtas av oss från annan källa. Nedan riktlinjer följer de skyldigheter och rättigheter som gäller enligt dataskyddsförordningen eller annan rättsligt bindande bestämmelse.
                  </Text>
                </Box>
                <Box mt={["40px", null, "50px"]}>
                  <Title variant="card" fontSize="2rem" mb="30px">
