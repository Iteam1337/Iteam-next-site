            ...
            <Col lg="12" xl="10" className="offset-xl-1">
              <Box pb={["40px", null, "65px"]}>
                ...
                <Text variant="small">
                  ...
                  projekt, genom att ta tillvara på egen innovation och lärande
                  samt genom att hjälpa våra kunder samverka och engagera med
                  ...
                  Movement arbetar vi med en AI-baserad tjänst för att samordna
                  transporter i glesbygd. Nu söker vi dig som kommer vara en
                  nyckelperson för att Iteam ska fortsätta vara en partner i
                  teknisk och strategisk framkant, ett måste för hållbara
                  digitala lösningar i ett samhälle av idag.
                  <br />
                  <br />
              ...
              <Box pb={["40px", null, "65px"]}>
                ...
                <Text variant="small">
                  ...
                  innovativa applikationer med hjälp av den senaste tekniken. Du
                  utforskar och utvärderar nya tekniker och metoder, sprider din
                  kunskap och omsätter den i praktiken - i ditt dagliga arbete
              ...
              <Box pb={["40px", null, "65px"]}>
                ...
                <ul style={{ listStyle: "disc", marginLeft: "3rem" }}>
                  ...
                  <li>
                    1+ års erfarenhet av ledarskap (t.ex. coacha, mentorera,
                    facilitera och leda grupper, hålla utbildning, tech lead)
                  </li>
