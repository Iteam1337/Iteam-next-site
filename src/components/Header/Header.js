    ...
    <>
        ...
        <Container fluid>
          <nav className="navbar site-navbar offcanvas-active navbar-expand-lg navbar-light">
            ...
            <ToggleButton
              ...
              dark={isDark ? 1 : 0}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill={isDark ? "white" : "black"} className="bi bi-list" viewBox="0 0 16 16">
      ...
      >
        <CrossWrapper onClick={() => {
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="white" className="bi bi-x" viewBox="0 0 16 16">
